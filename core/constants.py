...
ENERGY_IMAGES_DIR = os.path.join(BASE_DIR, 'assets', 'energy_images')
...
SEARCH_SUCCESS_CHANCE = 0.70

# --- События поиска ---
# Автоматически меняются по локальному времени бота. Все события положительные:
# они слегка меняют награды, шанс двойной находки или шанс более редкой находки.
SEARCH_EVENT_ROTATION_PERIOD_SEC = 21600  # 6 часов
SEARCH_EVENTS = [
    {
        'key': 'night_shift',
        'emoji': '🌙',
        'title_ru': 'Ночная смена',
        'title_en': 'Night shift',
        'desc_ru': '+15% к шансу двойной находки и +10% к септимам за поиск.',
        'desc_en': '+15% double-drop chance and +10% search septims.',
        'double_drop_bonus': 0.15,
        'coin_bonus_percent': 10,
        'rarity_weight_bonus_percent': 0,
        'swaga_bonus_cards': 0,
    },
    {
        'key': 'heatwave',
        ...
        'title_ru': 'Жара',
        'title_en': 'Heatwave',
        'desc_ru': '+20% к септимам за поиск, редкие энергетики выпадают немного чаще.',
        'desc_en': '+20% search septims, rare drinks appear a bit more often.',
        'double_drop_bonus': 0.0,
        'coin_bonus_percent': 20,
        'rarity_weight_bonus_percent': 15,
        'swaga_bonus_cards': 0,
    },
    {
        'key': 'energy_festival',
        'emoji': '🎪',
        'title_ru': 'Фестиваль энергетиков',
        'title_en': 'Energy festival',
        'desc_ru': '+10% к шансу двойной находки и +5 свага-карт за поиск.',
        'desc_en': '+10% double-drop chance and +5 Swaga cards per search.',
        'double_drop_bonus': 0.10,
    ...
    },
    {
        'key': 'rare_route',
        'emoji': '🧭',
        'title_ru': 'Редкий маршрут',
        'title_en': 'Rare route',
        'desc_ru': '+5% к септимам за поиск, редкие энергетики выпадают чаще.',
        'desc_en': '+5% search septims, rare drinks appear more often.',
        'double_drop_bonus': 0.0,
        'coin_bonus_percent': 5,
        'rarity_weight_bonus_percent': 25,
        'swaga_bonus_cards': 0,
    },
    {
        'key': 'morning_delivery',
        'emoji': '🚚',
        'title_ru': 'Утренняя поставка',
        'title_en': 'Morning delivery',
        'desc_ru': '+12% к септимам за поиск и +3 свага-карты за поиск.',
        'desc_en': '+12% search septims and +3 Swaga cards per search.',
        'double_drop_bonus': 0.0,
        'coin_bonus_percent': 12,
        'rarity_weight_bonus_percent': 0,
        'swaga_bonus_cards': 3,
    },
    {
        'key': 'lucky_scanner',
        'emoji': '📡',
        'title_ru': 'Счастливый сканер',
        'title_en': 'Lucky scanner',
        'desc_ru': '+12% к шансу двойной находки, редкие энергетики выпадают немного чаще.',
        'desc_en': '+12% double-drop chance, rare drinks appear a bit more often.',
        'double_drop_bonus': 0.12,
        'coin_bonus_percent': 0,
        'rarity_weight_bonus_percent': 10,
        'swaga_bonus_cards': 0,
    },
    {
        'key': 'collector_hour',
        'emoji': '🧃',
        'title_ru': 'Час коллекционера',
        'title_en': 'Collector hour',
        'desc_ru': '+7 свага-карт за поиск и +5% к септимам за поиск.',
        'desc_en': '+7 Swaga cards per search and +5% search septims.',
        'double_drop_bonus': 0.0,
        'coin_bonus_percent': 5,
        'rarity_weight_bonus_percent': 0,
        'swaga_bonus_cards': 7,
    },
    {
        'key': 'neon_market',
        'emoji': '🌆',
        'title_ru': 'Неоновый рынок',
        'title_en': 'Neon market',
        'desc_ru': '+18% к септимам за поиск, редкие энергетики выпадают немного чаще.',
        'desc_en': '+18% search septims, rare drinks appear a bit more often.',
        'double_drop_bonus': 0.0,
        'coin_bonus_percent': 18,
        'rarity_weight_bonus_percent': 12,
        'swaga_bonus_cards': 0,
    },
    {
        'key': 'warehouse_rush',
        'emoji': '📦',
        'title_ru': 'Складской ажиотаж',
        'title_en': 'Warehouse rush',
        'desc_ru': '+8% к шансу двойной находки и +4 свага-карты за поиск.',
        'desc_en': '+8% double-drop chance and +4 Swaga cards per search.',
        'double_drop_bonus': 0.08,
        'coin_bonus_percent': 0,
        'rarity_weight_bonus_percent': 0,
        'swaga_bonus_cards': 4,
    },
    {
        'key': 'golden_receipts',
        'emoji': '🧾',
        'title_ru': 'Золотые чеки',
        'title_en': 'Golden receipts',
        'desc_ru': '+25% к септимам за поиск.',
        'desc_en': '+25% search septims.',
        'double_drop_bonus': 0.0,
        'coin_bonus_percent': 25,
        'rarity_weight_bonus_percent': 0,
        'swaga_bonus_cards': 0,
    },
    {
        'key': 'blackout_hunt',
        'emoji': '🔦',
        'title_ru': 'Охота в блэкаут',
        'title_en': 'Blackout hunt',
        'desc_ru': '+6% к шансу двойной находки, редкие энергетики выпадают заметно чаще.',
        'desc_en': '+6% double-drop chance, rare drinks appear noticeably more often.',
        'double_drop_bonus': 0.06,
        'coin_bonus_percent': 0,
        'rarity_weight_bonus_percent': 30,
        'swaga_bonus_cards': 0,
    },
]
